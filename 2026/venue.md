...
### I3D 2026 is hosted at Lucasfilm!

We are pleased to announce that I3D 2026 will take place at Lucasfilm,
San Francisco, CA, USA

{% include carousel.html images="Premier_Theater.jpg,Yoda_Fountain-Twilight-GG-9701.jpg,yoda_fountain_lndscp.jpg,Yoda-Fountain.jpg" path_prefix="img/venue/" %}
...
{% include map-embed.html link="https://maps.app.goo.gl/dCARzmShCPhoDpvM9" image="img/venue/LucasFilmLocation.jpg" %}

The closest airport to the venue is **San Francisco International Airport (SFO)**. 
...
- From **San Francisco International Airport (SFO)**, attendees can use [BART](https://www.bart.gov/) + bus connections or rideshare.
