<?php include("header.php") ?>
          ...
          <p>Keynote Speaker Slides:
            <ul>
              <li><a href="matthias_muller_slides.pdf"><b>Physics in Games</b> by Matthias Müller</a></li>
            </ul>
          </p>

          <hr>

          <p>Congratulations to the following authors for being selected to
          extend their papers to the IEEE Transactions on Visualization and
          Computer Graphics (TVCG):
            <ul>
              <li>
                <b>Aggregate G-Buffer Anti-Aliasing</b><br>
                Cyril Crassin, Morgan McGuire, Kayvon Fatahalian, Aaron Lefohn 
              </li>
              <li>
                <b>Fast, Memory-Efficient Construction of Voxelized Shadows</b><br>
                Viktor Kämpe, Erik Sintorn, Ulf Assarsson 
              </li>
              <li>
                <b>Compressed Coverage Masks for Path Rendering on Mobile GPUs</b><br>
                Pavel Krajcevski, Dinesh Manocha 
              </li>
              <li>
                <b>Frustum-Traced Raster Shadows: Revisiting Irregular Z-Buffers</b><br>
          ...
          <ol>
            ...
            <li>
              <b>Simulation and Rendering for Millions of Grass Blades</b><br>
          ...
          <p><b>Best Poster</b></p>
            <ul>
              <li>
                <b>Rapid Photorealistic Blendshapes from Commodity RGB-D Sensors</b><br>
          ...
          <p>Stephen DiVerdi from Google and Kenny Mitchell from Disney Research will be hosting the <a href="program.php#industry_panel">Industry Panel</a> titled 'Latency in I3D'. The panelists are:
          <ul>
            <li>Dennis Harper, Onlive</li>
            <li>Natalya Tatarchuk, Bungie</li>
            <li>Lutz Latta, Lucasfilm</li>
            <li>Warren Hunt, Oculus VR</li>
          </ul>
          </p>

          <hr>

          <p>We are pleased to announce the <a href="keynotes.php">keynotes</a> for this year:
          <ul class="unstyled">
            <li><p>
